...
const
  ...
  FD_READ                               = (1 shl FD_READ_BIT);//1
  FD_WRITE                              = (1 shl FD_WRITE_BIT);//2
  FD_OOB                                = (1 shl FD_OOB_BIT);//4
  FD_ACCEPT                             = (1 shl FD_ACCEPT_BIT);//8
  FD_CONNECT                            = (1 shl FD_CONNECT_BIT);//16
  FD_CLOSE                              = (1 shl FD_CLOSE_BIT);//32
  FD_QOS                                = (1 shl FD_QOS_BIT);//64
  FD_GROUP_QOS                          = (1 shl FD_GROUP_QOS_BIT);//128
