...
//  TC_LOG_DELETED                        = 'DELETED';
  ...
  TC_IMPROPERWINTERFIELDDAYCLASS        = 'Field Day class must be H, I, O or M.';
...
//  TC_WASADUPE                           = '%s was a dupe.';
  ...
  TC_REPEATRSTSENT                      = 'Repeat RST sent';
 {
  ...
  RC_TOOLS                              = 'Tools';
  RC_SYNPCTIME                          = 'Synchronize PC time';
  ...
  RC_SERVERANSWER                       = 'Server answer';
  RC_SYNCLOCK                           = '&Synchronize clock';
  RC_LOCALTIME                          = 'Local time';
  ...
  RC_POSSBADZONE                        = 'Possible bad zone';
...
//  RC_SENDSPOT2                          = 'Send spot';
  ...
  RC_COMMENT                            = 'Comment';
  RC_RETURNTOMOD                        = 'Modify';
  RC_ARROWTOSELIT                       = 'Arrow/pageup/pagedn keys or 1st letter to select item.';
  RC_ALTW                               = 'Save (Alt-&W)';
  RC_ALTN                               = 'To &network';
  RC_ALTG                               = 'Save all (Alt-&G)';
  RC_COAX                               = 'COAX Length Calculator';
  RC_ENTERTNHINIK                       = 'Enter the next highest impedance null in kHz:';
  RC_ENTERALIFIK                        = 'Enter a low impedance frequency in kHz:';
  RC_DISTANCEBTGS                       = 'Distance between two grid squares';
  RC_SECONDGRID                         = 'Second grid';
  RC_FIRSTGRID                          = 'First grid';
  RC_EURVHFDIST                         = 'European VHF Distance:';
  RC_GRIDOFAGLL                         = 'Grid of a given lat/lon';
  RC_LONGMIE                            = 'Longitude (minus is east)';
  RC_LATMIS                             = 'Latitude (minus is south)';
  RC_CALCOFCORI                         = 'Calculation of capacitance or inductance';
  RC_INDUCANCE                          = 'Inductance, uH';
  RC_CAPACITANCE                        = 'Capacitance, pf';
  RC_FREQOFRES                          = 'Frequency of resonance, khz';

  RC_SHOWMENU                           = '&Show menu';
...
//  RC_INTERCOM2                          = 'Intercom';
  ...
  RC_CLEARFILTER                        = 'Clear filter';
  RC_STATIONS2                          = 'Stations';
  RC_C_EDITQSO                          = 'Edit QSO ';
  RC_C_DELETEQSO                        = 'Delete QSO';
  RC_COPYTOCLIP                         = 'Copy to clipboard';

//  RC_WINKEYSET                          = 'Winkeyer Settings';
  RC_DATE                               = 'Date';
  RC_NUMBERSENT                         = 'Number Sent';
  RC_NUMBERRCVD                         = 'Number Rcvd';
  RC_RSTSENT                            = 'RST sent';
  RC_RSTRECEIVED                        = 'RST received';
  RC_QSOPOINTS                          = 'QSO points';
  RC_AGE                                = 'Age';
  RC_FREQUENCYHZ                        = 'Frequency, Hz';
  RC_PREFIX                             = 'Prefix';
  RC_ZONE                               = 'Zone';
  RC_NAME                               = 'Name';
  RC_POSTALCODE                         = 'Postal Code';
  RC_POWER                              = 'Power';
