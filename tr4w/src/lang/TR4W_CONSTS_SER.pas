const
  ...
  TC_DISBALE_CIV                        = 'Iskljuci "CI-V Transceive" mode in your ICOM rig.';
  ...
  TC_QSO_IMPORTED                       = 'Qs imporovano.'; // - '345 Qs importovano.'
  TC_ISADUPE                            = '%s dupla!!';
  ...
  TC_CLEAR_DUPESHEET_NET                = '"CLEARDUPESHEET" za ciscenje svih lista duplih na mrezi';
  TC_CLEAR_MULTSHEET_NET                = '"CLEARMULTSHEET" za ciscenje svih lista mnozitelja na mrezi';
  ...
  TC_MULTSHEETCLEARED                   = 'Lista mnozitelja obrisana!';
  TC_PADDLE                             = 'Rucice';
  TC_FOOTSW                             = 'Futsvic';
  ...
  TC_DOYOUWANTTOCHECKTHELATESTVERSION   = 'Provera da li je ovo poslednja verzija programa';

  {NEW CONTEST}
  TC_LATEST_CONFIG_FILE                 = 'Poslednji konfiguracioni fajl';
  TC_OPENCONFIGURATIONFILE              = ' - Otvori konfiguracioni fajl ili kreiraj konfiguraciju za novo takmicenje';
  ...
  TC_ENTERYOURIOTAREFERENCEDESIGNATOR   = 'Upisi svoju IOTA:';
  ...
  TC_ENTERYOURCONTINENT                 = 'Upisi svoj kontinent (moguci dodatni ID, npr. SAYL ili NAQRP)';
  ...
  TC_INSERT                             = 'Uneti';
  TC_OVERRIDE                           = 'Zamena';
  TC_UNKNOWNCOUNTRY                     = 'Nepoznata DXCC';
  ...
  TC_WAITINGFORYOUENTERSTRENGTHOFRST    = 'Upisi jacine signala (S) u RST (jedan broj)';
  ...
  TC_NEWAUTOSAPENABLESENSITIVITYINHZSEC = 'Nova osetljivost autopretrage u Hz/sek)';
  TC_NEWBANDMAPDECAYTIMEMINUTES         = 'Novo vreme obnavljanja BANDMAPE (u minutima)';
  ...
  TC_YOUCANONLYCHANGETHISWHENCLIENTDISC = 'ovo se moze izmeniti samo tada, kada se klijent odjavi sa servera TR4W.';
  TC_COMPUTERIDAZRETURNNONE             = 'identifikacija racunara (od A - Z ili ENTER ako nema)';
  ...
  TC_COMPUTERNAME                       = 'Ime kompjutera (7 karaktera maksimalno)';
  ...
  TC_FREQPOLLRATEINMS                   = 'brzina preuzimanja podataka sa uredaja u milisekundama (10-1000)';
  ...
  {UCHECKLATESTVERSION}
  TC_VERSIONONSERVER                    = 'Verzija na serveru';
  ...
  {CUSTOM CARET}
  CCA1                                  = 'Korisnicki podesen ';
  CCA2                                  = 'Standardni oblik i sirina pokazivaca';
  ...
  CEC1                                  = 'Pitaj za SNIMI kada napusta AltE';
  ...
  {FARNSWORTH SPEED}
  FWS1                                  = 'Brzina gde je povecanje razmaka ispod';
  ...
  SAB2                                  = 'Alt-B ne zadrzava ostale aktivne opsege';
  ...
  RC_CLEARLOG                           = 'Obrisi dnevnik';
  RC_OPENLOGDIR                         = 'Otvori direktorijum gde je dnevnik';
  RC_EXPORT                             = 'Eksport';
  ...
  RC_CFG_COMMANDS                       = 'Podesavanje opcija programa';
  RC_PROGRAMMES                         = 'Programiranje poruka';
  RC_CATANDCW                           = 'CAT i CW podesavanja';
  RC_RADIOONE                           = 'Stanica 1';
  RC_RADIOTWO                           = 'Stanica 2';
  RC_WINDOWS                            = 'Prozori';
  RC_BANDMAP                            = 'Bandmapa';
  ...
  RC_LC                                 = 'LC';
  RC_NET                                = 'Mreza';
  RC_TIMESYN                            = 'Sinhronizacija vremena';
  ...
  RC_CONTENTS                           = 'Sadrzaj';
  RC_ABOUT                              = 'O programu';
  RC_SAVEINFOLDER                       = 'Snimi u direktorijum ''[godina] [takmicenje] [znak]''';
  RC_CONFFILE                           = 'Konfiguraciona datoteka';
  RC_EDITQSO                            = 'Izmeni QSO';
  RC_DELETED                            = '&Obrisano';
  RC_DUPE                               = 'Dupla';
  RC_LOGSEARCH                          = 'Pretraga dnevnika';
  RC_SEARCH                             = 'Pretraga';
  ...
  RC_DUPESHEET2                         = 'Lista duplih';
  RC_SENDSPOT2                          = 'Posalji spot';
  RC_CONTESTNAMEIC                      = 'I&me takmicenja u komentar';
  RC_SEND                               = '&Posalji';
  RC_COMMENT                            = 'Komentar';
  RC_SENDINGCW                          = 'Slanje CW preko tastature. Koristi ENTER/Escape/F10 za izlaz.';
  ...
  RC_NUMBEROSOLT                        = 'Broj sekundi za slusanje:';
  ...
  RC_SYNLOG2                            = 'Sinhronizuj dnevnik';
  ...
  RC_WINKEYSET                          = 'Winkeyer podesavanja';
