...
const
  ...
  TC_2RADIO_WARN                        = 'CHYBA: 2 stanice na jednom pásmu';
  ...
  TC_FREQ_ZERO                          = 'CHYBA: Zalogována neplatná frekvence';
  ...
  {MAIN}
  TC_ENTERYOURISTRICTIFINVE7            = 'Zadejte svùj federální okres, pokud jste v British Columbia, nebo svùj stát/provincii';  // 4.97.6
  ...
  TC_WANTTOCONVERTLOG                   = 'Chcete pøevést tento log na nejnovìjší formát?';
  TC_LOGFILENOTFOUND                    = 'Soubor logu nenalezen';
  TC_CANNOTBACKUPLOG                    = 'Nelze vytvoøit zálohu ';
  TC_CANNOTCOPYLOGREADONLY              = 'Nelze zkopírovat soubor logu -- cíl existuje a je pouze pro ètení';
  TC_BACKUPCREATED                      = 'Záloha souboru logu vytvoøena';
  TC_CANNOTRENAME                       = 'Nelze pøejmenovat';
...
//  TC_LOG_DELETED                        = 'SMAZÁNO';
  ...
  {NEW CONTEST}
  TC_LABRE                              = 'Zadejte 2-znakové ID QTH';
  TC_IRTS                               = 'EI/GI, zadejte své hrabství';
  TC_EUDX                               = 'Zemì EU, zadejte ètyøznakový kód zemì';
  ...
  TC_IRELAND                            = 'Irsko';
  TC_GC                                 = 'speciální dvouznakové oznaèení'  ;
  TC_GAGARIN                            = 'speciální dvouznakové ID';
  ...
  TC_AUTOSYNCHRONIZINGLOG               = 'Automatická synchronizace logu ze serveru.';
...
{FD Additions NY4I}
  TC_PREF_OR_CQZONE                     = 'Zadej svoji CQ ZÓNU nebo JA PREFEKTURU';
