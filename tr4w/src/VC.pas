...
{ Note - # entries FOUR ARRAYS must match:
 ...
 ({Name: 'BATAVIA-FT;                }Email: nil;                      DF: nil;                 WA7BNM:  10686;                       QRZRUID: 0   ; Pxm: Prefix;        ZnM: NoZoneMults; AIE: GridInitialExchange; DM: GridSquares; P: 0; AE: RSTAndOrGridExchange;                        XM:CQDXCC; QP:YBFT8QP; ADIFName:'';   CABName:'')    // 4.90.11
      );
