...
{$IFEND}
  ...
  TR4W_CURRENTVERSION_NUMBER            = '4.91.0' ;  // N4af     New  Release


  TR4W_CURRENTVERSION                   = 'TR4W v.' + TR4W_CURRENTVERSION_NUMBER; //  {$IF MMTTYMODE} + '_mmtty'{$IFEND};//{$IF LANG <> 'ENG'} + ' [' + LANG + ']'{$IFEND}{$IF MMTTYMODE} + '_mmtty'{$IFEND};
  TR4W_CURRENTVERSIONDATE               = 'August 5, 2020' ;
...
{ Note - # entries FOUR ARRAYS must match:
 ...
 ({Name: 'WWDIGI';                     }Email: 'director@ww-digi.com';   DF: nil;                 WA7BNM:  650;                         QRZRUID: 0   ; Pxm: NoPrefixMults; ZnM: NoZoneMults; AIE: GridInitialExchange; DM: NoDomesticMults; P: 0; AE: GridExchange;                           XM:CQDXCC; QP:WWDIGIQP; ADIFName:'';   CABName:'WW-DIGI')    // 4.90.11
