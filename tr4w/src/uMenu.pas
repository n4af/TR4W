...
//  RC_TRANSFREQ_HK                       = #9'Ctrl+T';
  ...
  RC_REPEAT_POTA_HK                     = #9'Ctrl+T';
    ...
    T_MENU_ARRAY_SIZE                     = 179 {$IF MMTTYMODE} + 1{$IFEND}{$IF LANG = 'RUS'} + 3{$IFEND} + 2 {RC_RESET_RADIO_PORTS, separator, Repeat POTA Parks} + 2 {HamScore Resync + Status, Issue #783};
...
//    (mrText: RC_VIEWPAKSPOTS + RC_VIEWPAKSPOTS_HK; mrId: menu_ctrl_viewpacketspots),
 ...
 //{
    ...
    (mrText: RC_SPLITOFF + RC_SPLITOFF_HK; mrId: menu_ctrl_SplitOff),      // n4af 4.47.3
 ...
 //{
    ...
    (mrText: 'HamScore Status...';                mrId: menu_hamscore_window),  // Issue #783 Phase 4
 //}
    (mrText: '-'; mrId: 0),
