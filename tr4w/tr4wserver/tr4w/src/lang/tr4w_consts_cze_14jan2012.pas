const
  ...
  TC_ISADUPE                            = '%s je dvoják!!';
  TC_ERRORINLOGFILE                     = 'Chyba v souboru .TRW!';
  TC_HASIMPROPERSYNTAX                  = '%s má nesprávnou syntaxi!!';
  TC_SORRYNOLOG                         = 'Sorry!! NO LOG = TRUE blokuje zápis QSO na tomto poèítaèi';
  ...
  TC_ENTERYOURGEOGRAPHICALCOORDINATES   = 'Zadej své zemìpisné koordináty'#13'(napø. 55N37O for Moskvu):';
  ...
  TC_ENTERYOURFOURDIGITGRIDSQUARE       = 'Zadej ètyømístný WW lokátor (napø. JO70):';
  TC_RFAS                               = 'Zadej své zemìpisné koordináty:';
  ...
  TC_CONNECTIONTOTR4WSERVERLOST         = 'Pøipojení k TR4WSERVER %s:%d bylo pøerušeno.';
  TC_COMPUTERCLOCKISSYNCHRONIZED        = 'Hodiny PC jsou synchronizovány.';
  TC_CONNECTINGTO                       = 'Pøipojuje se k ';
  TC_CONNECTTOTR4WSERVERFAILED          = 'Pøipojení k TR4WSERVER neúspìšné. Ovìø heslo!!';
  ...
  TC_IMPROPERDOMESITCQTH                = 'Nesprávné domestic QTH!!';
  TC_IMPROPERDOMESITCQTHORMISSINGNAME   = 'Nesprávné domestic QTH nebo chybí jméno!!';
  ...
  TC_WASADUPE                           = '%s byl dvoják.';
  TC_ALTDCOMMANDDISABLED                = 'Pøíkaz Alt-D je blokován volbou SINGLE RADIO MODE = TRUE';
  TC_YOUHAVERESTOREDTHELASTDELETED      = 'Obnovil jsi poslední smazaný záznam v deníku!!';
  ...
  TC_ISADUPEANDWILLBELOGGEDWITHZERO     = '%s je dvoják a bude zapsán v deníku s hodnotou 0 bodù.';
  ...
  TC_KEYCOMP                            = 'Kompenzace klíè.relé';
  TC_PADDLESWITCHPOINT                  = 'Prodleva pádla';
  ...
  TC_SORRYYOUALREADYHAVE10QTCSWITH      = 'Sorry, již máš 10 QTC od %s';
  TC_NOQTCSPENDINGQRU                   = 'Žádné QTC, QRU.';
  TC_ISQRVFOR                           = 'Je %s QRV pro %s?';

  {UREMMULTS}

  TC_CLEANSWEEPCONGRATULATIONS          = 'ZAMETENO!! BLAHOPØEJEME!!';
  ...
  TC_SALUTATION_AND_NAME_IF_KNOWN       = 'Pozdrav a jméno (pokud je známo)';
  ...
  TC_TOGGLESSENDINGSENDING              = 'Pøepne vysílání — vysílání bez monitorování - CW';
  ...
  RC_EXPORT                             = 'Export';
  RC_INIEXLIST                          = 'Seznam Initial exchanges';
  ...
  RC_SUMMARY                            = 'Záhlaví deníku (Cabrillo)';
  RC_EXIT                               = 'Konec';
  ...
  RC_TOOGLEST                           = 'Ovladaè pøíposlechu';
  RC_TOOGLEAS                           = 'Ovladaè automatu vysílání';
  ...
  RC_REFRESHBM                          = 'Obnovit bandmap';
  RC_DUALINGCQ                          = 'Dvoupásmové CQ (M2T)';
  RC_CURSORINBM                         = 'Pøesunout kurzor do okna bandmap';
  RC_CURSORTELNET                       = 'Cursor in DX Cluster window';
  RC_QSOWITHNOCW                        = 'QSO s NOCW';
  RC_CT1BOHIS                           = 'Zobrazení CT1BOH info';
  RC_ADDBANDMAPPH                       = 'Vytvoø volné místo v oknì bandmap';
  RC_COMMANDS                           = 'Pøíkazy';
  RC_FOCUSINMW                          = 'Návrat do hlavního okna';
  RC_TOGGLEINSERT                       = 'Ovladaè módu INSERT';
  RC_ESCAPE                             = 'ESC';
  ...
  RC_DVPVOLCONTROL                      = 'Øízení hlasitosti DVP';
  ...
  RC_COPYTOCLIP                         = 'Kopíruj na monitor';
