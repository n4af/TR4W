...
const
  ...
  TC_CALIFORNIA                         = 'Kalifornija';
  TC_FLORIDA                            = 'Florida';
  TC_MICHIGAN                           = 'Micigan';
  TC_MINNESOTA                          = 'Minesota';
  TC_OHIO                               = 'Ohajo';
  TC_WASHINGTON                         = 'Vasington';
  TC_WISCONSIN                          = 'Viskonsin';
  TC_TEXAS                              = 'Teksas';
  TC_NORTHAMERICA                       = 'Severna Amerika';
  TC_RUSSIA                             = 'Rusija';
  TC_UKRAINE                            = 'Ukrajina';
  TC_CZECHREPUBLICORINSLOVAKIA          = 'Ceska Republika ili Slovacka';
  TC_BULGARIA                           = 'Bugarska';
  TC_ROMANIA                            = 'Rumunija';
  TC_HUNGARY                            = 'Madjarska';
  TC_BELGIUM                            = 'Belgija';
  TC_NETHERLANDS                        = 'Holandija';
  ...
  TC_FILESAVEDTOFLOPPYSUCCESSFULLY      = 'File snimljen na flopi uspesno';
  TC_FILESAVEDTOSUCCESSFULLY            = 'File snimljen na %s uspesno';
  ...
  TC_ALTRCOMMANDDISABLED                = 'Alt-R komanda iskljucena u liniji Jedan radio mod = True';
  ...
  {UCHECKLATESTVERSION}
  TC_VERSIONONSERVER                    = 'Version on server';
  TC_THISVERSION2                       = 'This version';
  TC_DOWNLOADIT                         = 'Download last version?';
