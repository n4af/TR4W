...
//  TR4W_DOWNLOAD_LINK_WITH_VER           = 'TR4W_DOWNLOAD_LINK';
...
//  KIR_                                  : PChar = 'При указании личных данных используйте кириллицу';
...
//    RSTCustomDomesticQTHOrQSONumberExchange, //wli
...
//    'RST CUSTOM DOMESTIC QTH OR QSO NUMBER',
    'RST NAME QTH',
...
//      'R4N-CHAMP',
  ...
  const
    ...
    ContestsBooleanArray                : array[ContestType] of Byte =
      ...
      ({Name: 'CQP';                        }ciCDC0 + ciCQZoneMode0 + ciVHFEnabled0 + ciErmak0 + ciQB1 + ciQM1 + ciMB0 + ciMM0),
...
//      ({Name: 'AS-CHAMP-SSB';               }ciCDC0 + ciCQZoneMode0 + ciVHFEnabled0 + ciErmak1 + ciQB1 + ciQM0 + ciMB0 + ciMM0),
...
//      ({Name: 'R4N-CHAMP';                  }ciCDC0 + ciCQZoneMode0 + ciVHFEnabled0 + ciErmak1 + ciQB1 + ciQM1 + ciMB1 + ciMM1),
