const
  ...
  TC_QSO_IMPORTED                       = 'QSO omportována'; // - 'importováno 345 QSO.'
  ...
  TC_RULESONSM3CER                      = 'Pravidla pro závod %s na "WA7BNM Contest Calendar"';
  ...
  TC_ENTERYOURGEOGRAPHICALCOORDINATES   = 'Zadej své zemìpisné koordináty'#13'(napø. 55N37O pro Moskvu):';
  ...
  TC_ENTERYOURBRANCHNUMBER              = 'Zadej svùj Branch number:';
